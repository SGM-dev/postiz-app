  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by GoSocial?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information GoSocial will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'GoSocial' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'GoSocial' : 'Gitroom'
